...
class __TwigTemplate_8d74d261ce052dd4c3044bc8ab451a7cbfd9557f8ad476d137f161e5aa001229 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"form-group mb-2\">
        ...
        ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "prix", [], "any", false, false, false, 9), 'widget');
        echo "
    </div>
    ...
    <div class=\"form-group mb-2\">
        ...
        ";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "imageFile", [], "any", false, false, false, 14), 'widget');
        echo "
    </div>
...
{{ form_end(form) }}
", "admin/produits/_form.html.twig", "C:\\xampp\\htdocs\\www\\Sites\\Ecole\\PPE\\mainSite\\templates\\admin\\produits\\_form.html.twig");
    }
}
