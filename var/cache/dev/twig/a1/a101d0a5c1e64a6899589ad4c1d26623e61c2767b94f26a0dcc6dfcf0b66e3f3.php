...
class __TwigTemplate_5a915d0bb1d916f3e4566fa179a3a7742059e53704c2f466a15d807e898845b7 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["experience"]) {
            ...
            echo "                        <div class=\"resume-wrap d-flex align-item-stretch\" data-aos=\"fade-up\" data-aos-duration=\"1000\" data-aos-delay=\"400\">
                            <div class=\"w-100\">
                                ...
                                <span class=\"date\">";
            // line 24
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["experience"], "startDate", [], "any", false, false, false, 24), "m-Y"), "html", null, true);
            echo "  / ";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["experience"], "endDate", [], "any", false, false, false, 24), "m-Y"), "html", null, true);
            echo "</span>
                                <h2>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["experience"], "libelle", [], "any", false, false, false, 25), "html", null, true);
            echo "</h2>
                                <span class=\"position\"><i class=\"ion-ios-pin me-2\"></i>";
            // line 26
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["experience"], "societe", [], "any", false, false, false, 26), "html", null, true);
            echo " - ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["experience"], "location", [], "any", false, false, false, 26), "html", null, true);
            echo "</span>
                                <p class=\"mt-4\">";
            // line 27
            echo twig_get_attribute($this->env, $this->source, $context["experience"], "description", [], "any", false, false, false, 27);
            echo "</p>
                            </div>
                        </div>
                    ";
...
";
    ...
    {
        return array (  138 => 35,  132 => 31,  122 => 27,  116 => 26,  112 => 25,  106 => 24,  101 => 21,  97 => 20,  84 => 10,  76 => 9,  68 => 3,  58 => 2,  35 => 1,);
    }
        ...
        <div class=\"container\">
            <div class=\"row no-gutters slider-text align-items-end justify-content-center\">
                <div class=\"col-md-9 pt-5 text-center\">
                    ...
                    <h1 class=\"mb-0 bread\">{{ translate('experiencePage') }}</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class=\"col-md-12\">
                    {% for experience in experiences %}
                        <div class=\"resume-wrap d-flex align-item-stretch\" data-aos=\"fade-up\" data-aos-duration=\"1000\" data-aos-delay=\"400\">
                            <div class=\"w-100\">
                                <div class=\"icon\"><span class=\"flaticon-work-from-home\"></span></div>
                                <span class=\"date\">{{ experience.startDate|date('m-Y') }}  / {{ experience.endDate|date('m-Y')  }}</span>
                                <h2>{{ experience.libelle }}</h2>
                                <span class=\"position\"><i class=\"ion-ios-pin me-2\"></i>{{ experience.societe }} - {{ experience.location }}</span>
                                <p class=\"mt-4\">{{ experience.description | raw }}</p>
                            </div>
                        </div>
                    {% endfor %}
