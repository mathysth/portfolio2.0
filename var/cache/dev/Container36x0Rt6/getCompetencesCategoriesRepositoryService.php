 ...
 */
class getCompetencesCategoriesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompetencesCategoriesRepository' shared autowired service.
     *
     * @return \App\Repository\CompetencesCategoriesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompetencesCategoriesRepository.php';

        return $container->privates['App\\Repository\\CompetencesCategoriesRepository'] = new \App\Repository\CompetencesCategoriesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
