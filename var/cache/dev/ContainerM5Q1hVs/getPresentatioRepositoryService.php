 ...
 */
class getPresentatioRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PresentatioRepository' shared autowired service.
     *
     * @return \App\Repository\PresentatioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PresentatioRepository.php';

        return $container->privates['App\\Repository\\PresentatioRepository'] = new \App\Repository\PresentatioRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
